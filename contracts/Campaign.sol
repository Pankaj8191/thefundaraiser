...
contract CampaignFactory {
    ...
    event campaignCreated(
        ...
        address campaignAddress, string imgURI,
    ...
    string memory imgURI,string memory category,
    string memory storyURI) public
    {
        ...
        emit campaignCreated(campaignTitle, requiredCampaignAmount, 
        msg.sender, address(newCampaign),imgURI,
        block.timestamp,category);
    }
}
contract Campaign {
    string public title;
    ...
    constructor(string memory campaignTitle, uint requiredCampaignAmount,
                string memory imgURI, string memory storyURI) 
    {
        title = campaignTitle;
